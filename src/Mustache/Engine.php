...
class Engine
{
    ...
    public function __construct(array $options = array())
    {
        ...
        if (isset($options['escape'])) {
            if (!is_callable($options['escape'])) {
                throw new Exception\InvalidArgumentException('Mustache Constructor "escape" option must be callable');
            }
        ...
        if (isset($options['pragmas'])) {
            foreach ($options['pragmas'] as $pragma) {
                if (!isset(self::$knownPragmas[$pragma])) {
                    throw new Exception\InvalidArgumentException(sprintf('Unknown pragma: "%s".', $pragma));
                }
     ...
     *
     * @throws Exception\RuntimeException If the current Loader instance is immutable
     *
    ...
    public function setPartials(array $partials = array())
    {
        ...
        if (!$this->partialsLoader instanceof \Mustache\Loader\MutableLoader) {
            throw new Exception\RuntimeException('Unable to set partials on an immutable Mustache Loader instance');
        }
     ...
     *
     * @throws Exception\InvalidArgumentException if $helpers is not an array or Traversable
     *
    ...
    public function setHelpers($helpers)
    {
        if (!is_array($helpers) && !$helpers instanceof Traversable) {
            throw new Exception\InvalidArgumentException('setHelpers expects an array of helpers');
        }
    ...
    public function loadPartial($name)
    {
        ...
        } catch (Exception\UnknownTemplateException $e) {
